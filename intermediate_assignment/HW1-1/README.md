...
discussion에서 시각화 포트폴리오 > 2023년 11월 프리온보딩 데이터 챌린지 카테고리에 형식에 맞춰 글을 생성해 올려주시면 되겠습니다. label 설정으로 부동산, 마케팅 등등의 키워드를 함께 넣어주시면 가독성이 향상됩니다. 다른 분들이 작성한 시각화 작품을 보시고 인상깊다고 느끼는 글에 투표해주세요~
